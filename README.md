...
- [ ] Eu implementar a validação do código do país e do mês, para não deixar o usuário colocar um código que não existe ou um mês inválido. (Criar arquivo ex_04.py), 
